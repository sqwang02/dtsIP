 ...
 * 比如： 
 * 1 f(), g(String), h(byte[])
 * 2 o.f(), o.g(String), o.h(byte[])
 * 
 * xpath = .//PrimaryExpression/PrimaryPrefix/Name[@MethodName='true']
 *
 */
public class PlainFunctionInvokationSensitiveChecker implements ICommonFunctionSensitiveChecker
{
	
	//@Override
	public boolean checkUsed(VexNode n, FSMMachineInstance fsmin)
	{
		String xpath = ".//PrimaryExpression/PrimaryPrefix/Name[@MethodName='true']";
		/*
		 * 1 找到对应的语法节点
		 */
		...
		try
		{
			...
			for(int i=0; i<list.size(); i++)
			{
				...
				MethodNode methodnode = null;
					...
					//该节点必然为表达式节点
				ASTName aName = (ASTName)list.get(i);
						...
						//如果存在函数摘要
					{
							...
							//遍历所有的函数特征
						{
								...
								//遍历该函数特征的所有内容
							{
								...
								//获取该函数的参数列表
								ASTPrimaryExpression pe = (ASTPrimaryExpression) aName.getFirstParentOfType(ASTPrimaryExpression.class);
