...
public abstract class SimpleNode implements Node {
    ...
    protected int id;
    protected JavaParser parser;//解析器
    ...
    private String defectVariable=null;
	...
	public String getDefectVariable() {
		return defectVariable;
	}
	public void setDefectVariable(String defectVariable) {
		this.defectVariable = defectVariable;
	}
    ...
    public SimpleJavaNode getSelf(int i){
    	SimpleJavaNode denode=new SimpleJavaNode();
    	for (int j = 0; j< jjtGetNumChildren(); j++){
    		SimpleJavaNode child = (SimpleJavaNode) jjtGetChild(j);
    		if (child.getId()==i){
    			denode = child;
    			}
    		}
